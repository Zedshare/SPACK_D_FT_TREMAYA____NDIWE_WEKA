//search button
 document.getElementById('search').onclick = function(){
  alert('Under construction🧑‍💻🧑‍🔧🧑‍🔧 Bee🐝 is upgrading');
 }
 
 
 
 
/**Consider these statements NOW ASAP**/
//hey make sure evil things dont happen
//by evil things i mean bugs
//look for bugs to fix
//BUGS
//look for bugs now other wise
//
